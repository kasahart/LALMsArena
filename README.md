...
| [SALMONN-13B](https://huggingface.co/tsinghua-ee/SALMONN) | 13B | ~26 GB | tsinghua-ee/SALMONN |
...
> モデルキャッシュは `/mnt/kioxia_g2/model_cache/huggingface` に保存されます。  
> devcontainer および全推論コンテナは同パスをマウントして共有します。
